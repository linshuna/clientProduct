        ...
        <div class="Shopping">
            ...
            <div class="section">
                ...
                <div class="section_footer_ulaa">
                    <ul class="section_footer_ul">
                        <li v-for="(item,index) in RecommendList " :key="index"  @click.stop="nowBuyGoods(item.id)">
            ...
            <div class="footer">
                <div class="footer_top">
                    <button class="footer_top_button">全城{{shopNum}}家门店</button>
                </div>
            </div>
            <div>
              <nav>
                ...
                <div class="typename" @click="changeType(5)">
                    <p>{{typename}}</p>
                    <img src="../../../assets/images/btmArrow.png" alt="">
                </div>
                <p class="sort" @click="changeType(4)">{{sortsText}}
                    <img src="../../../assets/images/btmArrow.png" alt="">
                </p>
              </nav>
            </div>
            <pro-city-area v-bind:current.sync="currentPicker" v-bind:popupVisible.sync="popupVisible" @gainAllAddress="gainAllAddress" @gainSort="gainSort" @gainShopProject="gainShopProject"></pro-city-area>
            <template v-if="ShopStoreList&&ShopStoreList.length>0">
              <ul class="list">
                  <li v-for="item in ShopStoreList" @click.stop="shoppingDetail(item.id)">
                      <div class="footer_footer">
                          ...
                          <div class="footer_footer_section">
                              ...
                              <div class="footer_footer_section_right">
                                  ...
                                  <p class="footer_km">大约 {{item.distance | distanceFilter}}</p>
                              </div>
                          </div>
                      </div>
                  </li>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            shoppingDetail: function(id){
              this.$router.push({path: '/Index/UpKeep/Shopping/'+id})
            },
