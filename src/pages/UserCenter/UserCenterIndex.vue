    ...
    export default {
        ...
        data() {
            return {
                ...
                userSettingTypeData: [{
                  ...
                  'linkUrl':'/UserCenter/CarCountList',
                  'icon':require("@/assets/images/carCountIcon.png"),
                  'linkName': '我的车账本'
                }, {
        ...
        methods: {
            ...
            changeUrl:function(url){
              ...
              if(this.clientvid){
                if(!url) {this.$store.commit('showToast','敬请期待，正在开发中。。。');return;}
                this.$router.push({path: url})
              }else{
                this.$store.commit('showToast','请登录')            //如果没有登录
              }
            },
            isLogin: function(){
              if(!this.clientvid){
                ...
                this.$router.push({path:'/UserCenter/MyCenter'})
              }
            }
        }
    };
